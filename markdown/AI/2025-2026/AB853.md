...
tags:
  ...
  - privacy
  - regulation
keywords: artificial-intelligence, california, legislation, ai-transparency, provenance-data, online-platforms, capture-devices, privacy, regulation
hashTags: '#artificial-intelligence, #california, #legislation, #ai-transparency, #provenance-data, #online-platforms, #capture-devices, #privacy, #regulation'
billNumber: 853
...
summary: "Assembly Bill 853, the California AI Transparency Act, requires creators of generative AI systems with over 1 million monthly users in California to provide free AI detection tools that reveal whether content was generated or altered by their AI and output any system provenance data. The bill also mandates that large online platforms (over 2 million users) retain and make available provenance data for posted content, and that manufacturers of devices capable of recording photos, audio, or video (such as smartphones and cameras) include the option to embed provenance data in captured content. Violations are subject to civil penalties, and the bill includes new definitions and requirements to increase transparency and authenticity in AI-generated content."
...
> Assembly Bill 853, the California AI Transparency Act, requires creators of generative AI systems with over 1 million monthly users in California to provide free AI detection tools that reveal whether content was generated or altered by their AI and output any system provenance data. The bill also mandates that large online platforms (over 2 million users) retain and make available provenance data for posted content, and that manufacturers of devices capable of recording photos, audio, or video (such as smartphones and cameras) include the option to embed provenance data in captured content. Violations are subject to civil penalties, and the bill includes new definitions and requirements to increase transparency and authenticity in AI-generated content.
...
>- **Topic**: AB-853: California AI Transparency Act.
>- **Title**: AB-853: An act to amend Sections 22757.1 and 22757.4 of, and to add Section 22757.3.1 to, the Business and Professions Code, relating to artificial intelligence.
>- **TL;DR Summary**: Assembly Bill 853, the California AI Transparency Act, requires creators of generative AI systems with over 1 million monthly users in California to provide free AI detection tools that reveal whether content was generated or altered by their AI and output any system provenance data. The bill also mandates that large online platforms (over 2 million users) retain and make available provenance data for posted content, and that manufacturers of devices capable of recording photos, audio, or video (such as smartphones and cameras) include the option to embed provenance data in captured content. Violations are subject to civil penalties, and the bill includes new definitions and requirements to increase transparency and authenticity in AI-generated content.
>- **Keywords**: artificial-intelligence, california, legislation, ai-transparency, provenance-data, online-platforms, capture-devices, privacy, regulation
>- **Hash Tags**: #artificial-intelligence, #california, #legislation, #ai-transparency, #provenance-data, #online-platforms, #capture-devices, #privacy, #regulation
