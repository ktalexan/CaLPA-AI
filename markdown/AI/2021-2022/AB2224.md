...
keywords: artificial-intelligence, california, legislation, real-estate, ibuyers, regulation, business-and-professions-code
hashTags: '#artificial-intelligence, #california, #legislation, #real-estate, #ibuyers, #regulation, #business-and-professions-code'
billNumber: 2224
...
summary: "Assembly Bill 2224, introduced by Assembly Member McCarty in the 2021–2022 California legislative session, would require iBuyers—defined as online real estate companies that use automated valuation models (including artificial intelligence and statistical modeling) to purchase property without financing—to work with a local, county-based, licensed real estate broker when selling real property in California. The bill exempts initial sales of newly constructed properties from this requirement."
...
> Assembly Bill 2224, introduced by Assembly Member McCarty in the 2021–2022 California legislative session, would require iBuyers—defined as online real estate companies that use automated valuation models (including artificial intelligence and statistical modeling) to purchase property without financing—to work with a local, county-based, licensed real estate broker when selling real property in California. The bill exempts initial sales of newly constructed properties from this requirement.
...
>- **Topic**: AB-2224: Real estate: transactions: iBuyers.
>- **Title**: AB-2224: An act to add Chapter 3 (commencing with Section 11290) to Part 2 of Division 4 of the Business and Professions Code, relating to real estate.
>- **TL;DR Summary**: Assembly Bill 2224, introduced by Assembly Member McCarty in the 2021–2022 California legislative session, would require iBuyers—defined as online real estate companies that use automated valuation models (including artificial intelligence and statistical modeling) to purchase property without financing—to work with a local, county-based, licensed real estate broker when selling real property in California. The bill exempts initial sales of newly constructed properties from this requirement.
>- **Keywords**: artificial-intelligence, california, legislation, real-estate, ibuyers, regulation, business-and-professions-code
>- **Hash Tags**: #artificial-intelligence, #california, #legislation, #real-estate, #ibuyers, #regulation, #business-and-professions-code
