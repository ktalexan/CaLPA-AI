...
tags:
  ...
  - law
  - regulation
keywords: artificial-intelligence, california, social-media, privacy, digital-content, provenance, law, regulation
hashTags: '#artificial-intelligence, #california, #social-media, #privacy, #digital-content, #provenance, #law, #regulation'
billNumber: 1791
...
summary: "California Assembly Bill 1791, introduced by Assembly Member Weber and set to take effect on January 1, 2028, requires social media platforms to redact personal provenance data—information that can identify or be associated with individual users—from user-uploaded content unless the user provides express consent, while prohibiting platforms from redacting system provenance data (such as device or authenticity information) except under specific circumstances. The bill defines key terms like 'personal provenance data', 'system provenance data', and 'express consent', mandates labeling of content when both types of data must be redacted, and ensures compliance with relevant industry standards. Violations will be treated as unfair business practices under California law."
...
> California Assembly Bill 1791, introduced by Assembly Member Weber and set to take effect on January 1, 2028, requires social media platforms to redact personal provenance data—information that can identify or be associated with individual users—from user-uploaded content unless the user provides express consent, while prohibiting platforms from redacting system provenance data (such as device or authenticity information) except under specific circumstances. The bill defines key terms like 'personal provenance data', 'system provenance data', and 'express consent', mandates labeling of content when both types of data must be redacted, and ensures compliance with relevant industry standards. Violations will be treated as unfair business practices under California law.
...
>- **Topic**: AB-1791: Digital content provenance.
>- **Title**: AB-1791: An act to add Chapter 11.1 (commencing with Section 21760) to Division 8 of the Business and Professions Code, relating to social media platforms.
>- **TL;DR Summary**: California Assembly Bill 1791, introduced by Assembly Member Weber and set to take effect on January 1, 2028, requires social media platforms to redact personal provenance data—information that can identify or be associated with individual users—from user-uploaded content unless the user provides express consent, while prohibiting platforms from redacting system provenance data (such as device or authenticity information) except under specific circumstances. The bill defines key terms like 'personal provenance data', 'system provenance data', and 'express consent', mandates labeling of content when both types of data must be redacted, and ensures compliance with relevant industry standards. Violations will be treated as unfair business practices under California law.
>- **Keywords**: artificial-intelligence, california, social-media, privacy, digital-content, provenance, law, regulation
>- **Hash Tags**: #artificial-intelligence, #california, #social-media, #privacy, #digital-content, #provenance, #law, #regulation
