...
tags:
  ...
  - public-policy
  - technology
keywords: artificial-intelligence, california, state-government, commission, legislation, data-science, public-policy, technology
hashTags: '#artificial-intelligence, #california, #state-government, #commission, #legislation, #data-science, #public-policy, #technology'
billNumber: 976
...
summary: "AB 976 establishes the Artificial Intelligence in State Government Services Commission in California, comprising eight members with expertise in AI from various sectors. The advisory commission is tasked with annually gathering public input on how AI and data science can improve state services, proposing plans for AI demonstration projects, and recommending ways to integrate successful projects into government operations. The commission must set guiding principles by November 1, 2020, and submit annual recommendations to the Legislature and Governor starting in 2021. The commission is advisory only, with no implementation authority, and its provisions are set to be repealed on January 1, 2025."
...
>- **Topic**: AB-976: Artificial Intelligence in State Government Services Commission.
>- **Title**: AB-976: An act to add and repeal Chapter 8.3 (commencing with Section 11820.10) of Part 1 of Division 3 of Title 2 of the Government Code, relating to state government.
>- **TL;DR Summary**: AB 976 establishes the Artificial Intelligence in State Government Services Commission in California, comprising eight members with expertise in AI from various sectors. The advisory commission is tasked with annually gathering public input on how AI and data science can improve state services, proposing plans for AI demonstration projects, and recommending ways to integrate successful projects into government operations. The commission must set guiding principles by November 1, 2020, and submit annual recommendations to the Legislature and Governor starting in 2021. The commission is advisory only, with no implementation authority, and its provisions are set to be repealed on January 1, 2025.
>- **Keywords**: artificial-intelligence, california, state-government, commission, legislation, data-science, public-policy, technology
>- **Hash Tags**: #artificial-intelligence, #california, #state-government, #commission, #legislation, #data-science, #public-policy, #technology
