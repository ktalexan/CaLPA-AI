...
tags:
  ...
  - sb-721
  - senator-becker
keywords: artificial-intelligence, california-legislation, housing-policy, student-housing, land-use, government-code, annual-report, sb-721, senator-becker
hashTags: '#artificial-intelligence, #california-legislation, #housing-policy, #student-housing, #land-use, #government-code, #annual-report, #sb-721, #senator-becker'
billNumber: 721
...
summary: "Senate Bill 721, introduced by Senator Becker in the 2023-2024 California legislative session, amends Section 65400 of the Government Code to require cities and counties, starting with the 7th and subsequent revisions of their housing element, to include in their annual land use reports the number of suite-style student housing quarters that meet specified standards (such as having a full kitchen and adequate bathroom facilities). These units can count toward a jurisdiction's progress in meeting regional housing needs, but cannot exceed 25% of any income category. The bill does not require state reimbursement to local agencies for these new reporting requirements."
...
> Senate Bill 721, introduced by Senator Becker in the 2023-2024 California legislative session, amends Section 65400 of the Government Code to require cities and counties, starting with the 7th and subsequent revisions of their housing element, to include in their annual land use reports the number of suite-style student housing quarters that meet specified standards (such as having a full kitchen and adequate bathroom facilities). These units can count toward a jurisdiction's progress in meeting regional housing needs, but cannot exceed 25% of any income category. The bill does not require state reimbursement to local agencies for these new reporting requirements.
...
>- **Topic**: SB-721: General plan: annual report: suite-style student housing quarters.
>- **Title**: SB-721: An act to amend Section 65400 of the Government Code, relating to land use.
>- **TL;DR Summary**: Senate Bill 721, introduced by Senator Becker in the 2023-2024 California legislative session, amends Section 65400 of the Government Code to require cities and counties, starting with the 7th and subsequent revisions of their housing element, to include in their annual land use reports the number of suite-style student housing quarters that meet specified standards (such as having a full kitchen and adequate bathroom facilities). These units can count toward a jurisdiction's progress in meeting regional housing needs, but cannot exceed 25% of any income category. The bill does not require state reimbursement to local agencies for these new reporting requirements.
>- **Keywords**: artificial-intelligence, california-legislation, housing-policy, student-housing, land-use, government-code, annual-report, sb-721, senator-becker
>- **Hash Tags**: #artificial-intelligence, #california-legislation, #housing-policy, #student-housing, #land-use, #government-code, #annual-report, #sb-721, #senator-becker
