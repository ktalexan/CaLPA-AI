...
tags:
  ...
  - senate-bill-11
  - ashby
keywords: artificial-intelligence, california, legislation, consumer-protection, digital-replica, false-impersonation, evidence-law, civil-liability, senate-bill-11, ashby
hashTags: '#artificial-intelligence, #california, #legislation, #consumer-protection, #digital-replica, #false-impersonation, #evidence-law, #civil-liability, #senate-bill-11, #ashby'
billNumber: 11
...
summary: "Senate Bill 11, introduced by Senator Ashby in the 2025–2026 California legislative session, addresses the use of artificial intelligence (AI) and digital replicas. The bill clarifies that using AI-generated digital replicas to impersonate someone constitutes false personation under criminal law, and establishes that such replicas are considered the genuine likeness or voice of a person for civil liability purposes. It removes certain legal presumptions that previously protected employers in advertising contexts, directs the Judicial Council to develop rules for assessing AI-manipulated evidence in court by 2027, and requires AI providers to warn consumers about potential civil or criminal liability for misuse of digital replica technology, with penalties for noncompliance."
...
> Senate Bill 11, introduced by Senator Ashby in the 2025–2026 California legislative session, addresses the use of artificial intelligence (AI) and digital replicas. The bill clarifies that using AI-generated digital replicas to impersonate someone constitutes false personation under criminal law, and establishes that such replicas are considered the genuine likeness or voice of a person for civil liability purposes. It removes certain legal presumptions that previously protected employers in advertising contexts, directs the Judicial Council to develop rules for assessing AI-manipulated evidence in court by 2027, and requires AI providers to warn consumers about potential civil or criminal liability for misuse of digital replica technology, with penalties for noncompliance.
...
>- **Topic**: SB-11: Artificial intelligence technology.
>- **Title**: SB-11: An act to add Chapter 22.6 (commencing with Section 22650) to Division 8 of the Business and Professions Code, to amend Section 3344 of the Civil Code, to add Article 2.5 (commencing with Section 1425) to Chapter 1 of Division 11 of the Evidence Code, and to add Chapter 9 (commencing with Section 540) to Title 13 of Part 1 of the Penal Code, relating to artificial intelligence technology.
>- **TL;DR Summary**: Senate Bill 11, introduced by Senator Ashby in the 2025–2026 California legislative session, addresses the use of artificial intelligence (AI) and digital replicas. The bill clarifies that using AI-generated digital replicas to impersonate someone constitutes false personation under criminal law, and establishes that such replicas are considered the genuine likeness or voice of a person for civil liability purposes. It removes certain legal presumptions that previously protected employers in advertising contexts, directs the Judicial Council to develop rules for assessing AI-manipulated evidence in court by 2027, and requires AI providers to warn consumers about potential civil or criminal liability for misuse of digital replica technology, with penalties for noncompliance.
>- **Keywords**: artificial-intelligence, california, legislation, consumer-protection, digital-replica, false-impersonation, evidence-law, civil-liability, senate-bill-11, ashby
>- **Hash Tags**: #artificial-intelligence, #california, #legislation, #consumer-protection, #digital-replica, #false-impersonation, #evidence-law, #civil-liability, #senate-bill-11, #ashby
