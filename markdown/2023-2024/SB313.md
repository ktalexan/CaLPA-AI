...
tags:
  ...
  - public-disclosure
  - technology-policy
keywords: artificial-intelligence, california, state-government, privacy, civil-liberties, transparency, bias, public-disclosure, technology-policy
hashTags: '#artificial-intelligence, #california, #state-government, #privacy, #civil-liberties, #transparency, #bias, #public-disclosure, #technology-policy'
billNumber: 313
...
summary: "Senate Bill 313, known as the California AI-ware Act and introduced by Senator Dodd, proposes the creation of the Office of Artificial Intelligence within the California Department of Technology to guide the design and use of automated systems by state agencies. The bill aims to ensure that all AI systems comply with privacy and civil liberties laws, minimize bias, and promote equitable outcomes. It also requires state agencies using generative AI to communicate with the public to clearly disclose when interactions are AI-driven and provide instructions for users to reach a human representative, emphasizing transparency, fairness, and nondiscrimination in state use of AI."
...
> Senate Bill 313, known as the California AI-ware Act and introduced by Senator Dodd, proposes the creation of the Office of Artificial Intelligence within the California Department of Technology to guide the design and use of automated systems by state agencies. The bill aims to ensure that all AI systems comply with privacy and civil liberties laws, minimize bias, and promote equitable outcomes. It also requires state agencies using generative AI to communicate with the public to clearly disclose when interactions are AI-driven and provide instructions for users to reach a human representative, emphasizing transparency, fairness, and nondiscrimination in state use of AI.
...
>- **Topic**: SB-313: Department of Technology: Office of Artificial Intelligence: state agency public interface: use of AI.
>- **Title**: SB-313: An act to add Chapter 5.9 (commencing with Section 11549.80) to Part 1 of Division 3 of Title 2 of, the Government Code, relating to state government.
>- **TL;DR Summary**: Senate Bill 313, known as the California AI-ware Act and introduced by Senator Dodd, proposes the creation of the Office of Artificial Intelligence within the California Department of Technology to guide the design and use of automated systems by state agencies. The bill aims to ensure that all AI systems comply with privacy and civil liberties laws, minimize bias, and promote equitable outcomes. It also requires state agencies using generative AI to communicate with the public to clearly disclose when interactions are AI-driven and provide instructions for users to reach a human representative, emphasizing transparency, fairness, and nondiscrimination in state use of AI.
>- **Keywords**: artificial-intelligence, california, state-government, privacy, civil-liberties, transparency, bias, public-disclosure, technology-policy
>- **Hash Tags**: #artificial-intelligence, #california, #state-government, #privacy, #civil-liberties, #transparency, #bias, #public-disclosure, #technology-policy
