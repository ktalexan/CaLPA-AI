...
tags:
  ...
  - legislation
  - training-data
keywords: artificial-intelligence, california-law, ai-regulation, data-transparency, generative-ai, legislation, training-data
hashTags: '#artificial-intelligence, #california-law, #ai-regulation, #data-transparency, #generative-ai, #legislation, #training-data'
billNumber: 2013
...
summary: "Assembly Bill No. 2013 (Chapter 817), approved in California on September 28, 2024, requires developers of generative artificial intelligence (AI) systems or services released after January 1, 2022, to publicly post detailed documentation about the datasets used to train their AI, starting January 1, 2026, and before each subsequent release or substantial update. This documentation must include a high-level summary of dataset sources, content types, licensing, use of personal or copyrighted data, data processing, and timeframes, among other details. Certain AI systems developed solely for security, aviation, or federal defense purposes are exempt from these requirements."
...
> Assembly Bill No. 2013 (Chapter 817), approved in California on September 28, 2024, requires developers of generative artificial intelligence (AI) systems or services released after January 1, 2022, to publicly post detailed documentation about the datasets used to train their AI, starting January 1, 2026, and before each subsequent release or substantial update. This documentation must include a high-level summary of dataset sources, content types, licensing, use of personal or copyrighted data, data processing, and timeframes, among other details. Certain AI systems developed solely for security, aviation, or federal defense purposes are exempt from these requirements.
...
>- **Topic**: AB-2013: Generative artificial intelligence: training data transparency.
>- **Title**: AB-2013: An act to add Title 15.2 (commencing with Section 3110) to Part 4 of Division 3 of the Civil Code, relating to artificial intelligence.
>- **TL;DR Summary**: Assembly Bill No. 2013 (Chapter 817), approved in California on September 28, 2024, requires developers of generative artificial intelligence (AI) systems or services released after January 1, 2022, to publicly post detailed documentation about the datasets used to train their AI, starting January 1, 2026, and before each subsequent release or substantial update. This documentation must include a high-level summary of dataset sources, content types, licensing, use of personal or copyrighted data, data processing, and timeframes, among other details. Certain AI systems developed solely for security, aviation, or federal defense purposes are exempt from these requirements.
>- **Keywords**: artificial-intelligence, california-law, ai-regulation, data-transparency, generative-ai, legislation, training-data
>- **Hash Tags**: #artificial-intelligence, #california-law, #ai-regulation, #data-transparency, #generative-ai, #legislation, #training-data
