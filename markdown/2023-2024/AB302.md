...
tags:
  ...
  - risk-assessment
  - accountability
keywords: artificial-intelligence, california, legislation, automated-decision-systems, government-technology, privacy, risk-assessment, accountability
hashTags: '#artificial-intelligence, #california, #legislation, #automated-decision-systems, #government-technology, #privacy, #risk-assessment, #accountability'
billNumber: 302
...
summary: "Assembly Bill 302 requires the California Department of Technology to compile a comprehensive inventory of all high-risk automated decision systems—defined as AI-driven tools that significantly impact areas like housing, education, employment, healthcare, and criminal justice—proposed or used by state agencies (excluding UC, the Legislature, and courts) by September 1, 2024. The inventory must detail each system’s function, data use, risk mitigation measures, and alternatives. The Department must report its findings to legislative committees by January 1, 2025, and annually until 2029."
...
> Assembly Bill 302 requires the California Department of Technology to compile a comprehensive inventory of all high-risk automated decision systems—defined as AI-driven tools that significantly impact areas like housing, education, employment, healthcare, and criminal justice—proposed or used by state agencies (excluding UC, the Legislature, and courts) by September 1, 2024. The inventory must detail each system’s function, data use, risk mitigation measures, and alternatives. The Department must report its findings to legislative committees by January 1, 2025, and annually until 2029.
...
>- **Topic**: AB-302: Department of Technology: high-risk automated decision systems: inventory.
>- **Title**: AB-302: An act to add Section 11546.45.5 to the Government Code, relating to automated decision systems.
>- **TL;DR Summary**: Assembly Bill 302 requires the California Department of Technology to compile a comprehensive inventory of all high-risk automated decision systems—defined as AI-driven tools that significantly impact areas like housing, education, employment, healthcare, and criminal justice—proposed or used by state agencies (excluding UC, the Legislature, and courts) by September 1, 2024. The inventory must detail each system’s function, data use, risk mitigation measures, and alternatives. The Department must report its findings to legislative committees by January 1, 2025, and annually until 2029.
>- **Keywords**: artificial-intelligence, california, legislation, automated-decision-systems, government-technology, privacy, risk-assessment, accountability
>- **Hash Tags**: #artificial-intelligence, #california, #legislation, #automated-decision-systems, #government-technology, #privacy, #risk-assessment, #accountability
