...
tags:
  ...
  - employee-rights
  - retail
keywords: artificial-intelligence, california, labor-law, grocery-stores, self-checkout, workplace-technology, employee-rights, retail
hashTags: '#artificial-intelligence, #california, #labor-law, #grocery-stores, #self-checkout, #workplace-technology, #employee-rights, #retail'
billNumber: 1446
...
summary: "Senate Bill 1446, introduced by Senator Smallwood-Cuevas in the California Legislature's 2023–2024 session, seeks to regulate self-service checkout and the implementation of consequential workplace technology in grocery retail stores and retail drug establishments. The bill prohibits these businesses from offering self-service checkout unless specific conditions are met, such as limiting one employee to monitoring no more than two self-checkout stations (with no other duties), restricting self-checkout purchases to 15 items, and barring certain items like alcohol and tobacco. Businesses must also include self-checkout in their workplace safety programs. Furthermore, the bill requires at least 60 days' advance notice to workers, unions, and the public before implementing technology that automates, eliminates, or electronically monitors core job functions. Violations can result in civil penalties of $100 per day, up to $10,000."
...
>- **Keywords**: artificial-intelligence, california, labor-law, grocery-stores, self-checkout, workplace-technology, employee-rights, retail
>- **Hash Tags**: #artificial-intelligence, #california, #labor-law, #grocery-stores, #self-checkout, #workplace-technology, #employee-rights, #retail
