...
tags:
  ...
  - business-regulation
  - 2025
keywords: artificial-intelligence, california, legislation, cartwright-act, antitrust, pricing-algorithms, business-regulation, 2025
hashTags: '#artificial-intelligence, #california, #legislation, #cartwright-act, #antitrust, #pricing-algorithms, #business-regulation, #2025'
billNumber: 325
...
summary: "Assembly Bill 325, introduced in the 2025-2026 California legislative session, amends the Cartwright Act to make it unlawful for individuals or entities to use or distribute a common pricing algorithm—defined as any process, including those using artificial intelligence or machine learning, that sets or recommends prices or commercial terms for products or services—if they know or should know the same algorithm is used by others for similar purposes within California. The bill also clarifies that complaints for Cartwright Act violations need only allege plausible facts of anti-competitive conduct, not exclude independent action, and expands liability for violations, creating a new state-mandated local program but specifies no reimbursement is required for local agencies."
...
> Assembly Bill 325, introduced in the 2025-2026 California legislative session, amends the Cartwright Act to make it unlawful for individuals or entities to use or distribute a common pricing algorithm—defined as any process, including those using artificial intelligence or machine learning, that sets or recommends prices or commercial terms for products or services—if they know or should know the same algorithm is used by others for similar purposes within California. The bill also clarifies that complaints for Cartwright Act violations need only allege plausible facts of anti-competitive conduct, not exclude independent action, and expands liability for violations, creating a new state-mandated local program but specifies no reimbursement is required for local agencies.
...
>- **Topic**: AB-325: Cartwright Act: violations.
>- **Title**: AB-325: An act to add Sections 16729 and 16756.1 to the Business and Professions Code, relating to business regulations.
>- **TL;DR Summary**: Assembly Bill 325, introduced in the 2025-2026 California legislative session, amends the Cartwright Act to make it unlawful for individuals or entities to use or distribute a common pricing algorithm—defined as any process, including those using artificial intelligence or machine learning, that sets or recommends prices or commercial terms for products or services—if they know or should know the same algorithm is used by others for similar purposes within California. The bill also clarifies that complaints for Cartwright Act violations need only allege plausible facts of anti-competitive conduct, not exclude independent action, and expands liability for violations, creating a new state-mandated local program but specifies no reimbursement is required for local agencies.
>- **Keywords**: artificial-intelligence, california, legislation, cartwright-act, antitrust, pricing-algorithms, business-regulation, 2025
>- **Hash Tags**: #artificial-intelligence, #california, #legislation, #cartwright-act, #antitrust, #pricing-algorithms, #business-regulation, #2025
