...
keywords: artificial-intelligence, school-libraries, education, california, state-legislation, media-literacy, technology, curriculum-standards
hashTags: '#artificial-intelligence, #school-libraries, #education, #california, #state-legislation, #media-literacy, #technology, #curriculum-standards'
billNumber: 279
...
summary: "Assembly Bill 279, introduced by Assembly Member Patel, proposes to update California's school library standards by requiring the Superintendent of Public Instruction, in consultation with the State Board of Education, to review and potentially recommend revisions to these standards every eight years starting July 1, 2028. If revisions are deemed necessary, a group of experts—including teachers experienced with technology, media literacy, artificial intelligence, and social media—will be convened to assist in the process. The bill mandates at least two public hearings for input, and the revised standards must be presented to the State Board, which has the authority to adopt, reject, or modify them. The bill's implementation depends on budget appropriations."
...
> Assembly Bill 279, introduced by Assembly Member Patel, proposes to update California's school library standards by requiring the Superintendent of Public Instruction, in consultation with the State Board of Education, to review and potentially recommend revisions to these standards every eight years starting July 1, 2028. If revisions are deemed necessary, a group of experts—including teachers experienced with technology, media literacy, artificial intelligence, and social media—will be convened to assist in the process. The bill mandates at least two public hearings for input, and the revised standards must be presented to the State Board, which has the authority to adopt, reject, or modify them. The bill's implementation depends on budget appropriations.
...
>- **Topic**: AB-279: School libraries: model library standards.
>- **Title**: AB-279: An act to add Section 60605.14 to the Education Code, relating to school libraries.
>- **TL;DR Summary**: Assembly Bill 279, introduced by Assembly Member Patel, proposes to update California's school library standards by requiring the Superintendent of Public Instruction, in consultation with the State Board of Education, to review and potentially recommend revisions to these standards every eight years starting July 1, 2028. If revisions are deemed necessary, a group of experts—including teachers experienced with technology, media literacy, artificial intelligence, and social media—will be convened to assist in the process. The bill mandates at least two public hearings for input, and the revised standards must be presented to the State Board, which has the authority to adopt, reject, or modify them. The bill's implementation depends on budget appropriations.
>- **Keywords**: artificial-intelligence, school-libraries, education, california, state-legislation, media-literacy, technology, curriculum-standards
>- **Hash Tags**: #artificial-intelligence, #school-libraries, #education, #california, #state-legislation, #media-literacy, #technology, #curriculum-standards
