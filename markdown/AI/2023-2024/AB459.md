...
tags:
  ...
  - government
  - legislation
keywords: artificial-intelligence, california, law-enforcement, public-records, racial-profiling, data-reporting, privacy, government, legislation
hashTags: '#artificial-intelligence, #california, #law-enforcement, #public-records, #racial-profiling, #data-reporting, #privacy, #government, #legislation'
billNumber: 459
...
summary: "Assembly Bill 459, introduced by Assembly Member Kalra, amends California law to require state and local law enforcement agencies to submit annual stop data reports to the Attorney General by March 1, with semiannual reporting required if submission errors are found. The bill clarifies that open text or narrative fields in these reports, which may contain personally identifiable information, will only be publicly available from the reporting agency—not from the Attorney General—while still allowing researchers access under strict confidentiality agreements to study racial and identity profiling. The bill also includes legislative findings to justify limiting public access to certain sensitive information, and provides for state reimbursement of local agency costs if mandated."
...
> Assembly Bill 459, introduced by Assembly Member Kalra, amends California law to require state and local law enforcement agencies to submit annual stop data reports to the Attorney General by March 1, with semiannual reporting required if submission errors are found. The bill clarifies that open text or narrative fields in these reports, which may contain personally identifiable information, will only be publicly available from the reporting agency—not from the Attorney General—while still allowing researchers access under strict confidentiality agreements to study racial and identity profiling. The bill also includes legislative findings to justify limiting public access to certain sensitive information, and provides for state reimbursement of local agency costs if mandated.
...
>- **Topic**: AB-459: Peace officers: Attorney General: reports.
>- **Title**: AB-459: An act to amend Section 12525.5 of the Government Code, relating to law enforcement.
>- **TL;DR Summary**: Assembly Bill 459, introduced by Assembly Member Kalra, amends California law to require state and local law enforcement agencies to submit annual stop data reports to the Attorney General by March 1, with semiannual reporting required if submission errors are found. The bill clarifies that open text or narrative fields in these reports, which may contain personally identifiable information, will only be publicly available from the reporting agency—not from the Attorney General—while still allowing researchers access under strict confidentiality agreements to study racial and identity profiling. The bill also includes legislative findings to justify limiting public access to certain sensitive information, and provides for state reimbursement of local agency costs if mandated.
>- **Keywords**: artificial-intelligence, california, law-enforcement, public-records, racial-profiling, data-reporting, privacy, government, legislation
>- **Hash Tags**: #artificial-intelligence, #california, #law-enforcement, #public-records, #racial-profiling, #data-reporting, #privacy, #government, #legislation
