...
tags:
  ...
  - pricing-algorithms
  - consumer-protection
keywords: artificial-intelligence, california, legislation, antitrust, business-regulation, pricing-algorithms, consumer-protection
hashTags: '#artificial-intelligence, #california, #legislation, #antitrust, #business-regulation, #pricing-algorithms, #consumer-protection'
billNumber: 295
...
summary: "Senate Bill 295, the California Preventing Algorithmic Collusion Act of 2025, aims to regulate the use of pricing algorithms in California by prohibiting the use or distribution of algorithms that use, incorporate, or are trained with competitor data, and by requiring companies with $5 million or more in annual revenue to disclose to customers and workers when prices or commercial terms are set by such algorithms. The bill grants the Attorney General investigative powers, mandates officer certification of reports, and allows for significant civil penalties, including fines, forfeiture of corporate rights, and injunctions for violations. Contracts violating these provisions are declared void, and failure to provide required disclosures is considered an unfair trade practice."
...
> Senate Bill 295, the California Preventing Algorithmic Collusion Act of 2025, aims to regulate the use of pricing algorithms in California by prohibiting the use or distribution of algorithms that use, incorporate, or are trained with competitor data, and by requiring companies with $5 million or more in annual revenue to disclose to customers and workers when prices or commercial terms are set by such algorithms. The bill grants the Attorney General investigative powers, mandates officer certification of reports, and allows for significant civil penalties, including fines, forfeiture of corporate rights, and injunctions for violations. Contracts violating these provisions are declared void, and failure to provide required disclosures is considered an unfair trade practice.
...
>- **Topic**: SB-295: California Preventing Algorithmic Collusion Act of 2025.
>- **Title**: SB-295: An act to add Chapter 8 (commencing with Section 17370) to Part 2 of Division 7 of the Business and Professions Code, relating to business regulations.
>- **TL;DR Summary**: Senate Bill 295, the California Preventing Algorithmic Collusion Act of 2025, aims to regulate the use of pricing algorithms in California by prohibiting the use or distribution of algorithms that use, incorporate, or are trained with competitor data, and by requiring companies with $5 million or more in annual revenue to disclose to customers and workers when prices or commercial terms are set by such algorithms. The bill grants the Attorney General investigative powers, mandates officer certification of reports, and allows for significant civil penalties, including fines, forfeiture of corporate rights, and injunctions for violations. Contracts violating these provisions are declared void, and failure to provide required disclosures is considered an unfair trade practice.
>- **Keywords**: artificial-intelligence, california, legislation, antitrust, business-regulation, pricing-algorithms, consumer-protection
>- **Hash Tags**: #artificial-intelligence, #california, #legislation, #antitrust, #business-regulation, #pricing-algorithms, #consumer-protection
