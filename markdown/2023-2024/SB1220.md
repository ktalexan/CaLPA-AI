...
tags:
  ...
  - worker-protection
  - automation
keywords: artificial-intelligence, public-contracts, california, call-centers, labor-law, state-legislation, worker-protection, automation
hashTags: '#artificial-intelligence, #public-contracts, #california, #call-centers, #labor-law, #state-legislation, #worker-protection, #automation'
billNumber: 1220
...
summary: "Senate Bill 1220, introduced by Senator Limón, amends California's Public Contract Code to require that, until July 1, 2030, all state and local government agencies providing or contracting for public benefit program call center services must use workers employed in California and prohibits the use of artificial intelligence (AI) or automated decision systems (ADS) that would eliminate or automate core job functions. The bill extends these requirements to local agencies, removes certain health plan exemptions, and mandates notification to workers and the public if AI/ADS systems are used in ways that impact core job functions. Exceptions apply for emergencies, prior contracts, and translation services, and the bill includes provisions for penalties, contract termination, and state reimbursement to local agencies for mandated costs."
...
> Senate Bill 1220, introduced by Senator Limón, amends California's Public Contract Code to require that, until July 1, 2030, all state and local government agencies providing or contracting for public benefit program call center services must use workers employed in California and prohibits the use of artificial intelligence (AI) or automated decision systems (ADS) that would eliminate or automate core job functions. The bill extends these requirements to local agencies, removes certain health plan exemptions, and mandates notification to workers and the public if AI/ADS systems are used in ways that impact core job functions. Exceptions apply for emergencies, prior contracts, and translation services, and the bill includes provisions for penalties, contract termination, and state reimbursement to local agencies for mandated costs.
...
>- **Topic**: SB-1220: Public benefits contracts: phone operator jobs.
>- **Title**: SB-1220: An act to amend, repeal, and add Section 12140 of, and to amend the heading of Chapter 3.7 (commencing with Section 12140) of Part 2 of Division 2 of, the Public Contract Code, relating to public contracts.
>- **TL;DR Summary**: Senate Bill 1220, introduced by Senator Limón, amends California's Public Contract Code to require that, until July 1, 2030, all state and local government agencies providing or contracting for public benefit program call center services must use workers employed in California and prohibits the use of artificial intelligence (AI) or automated decision systems (ADS) that would eliminate or automate core job functions. The bill extends these requirements to local agencies, removes certain health plan exemptions, and mandates notification to workers and the public if AI/ADS systems are used in ways that impact core job functions. Exceptions apply for emergencies, prior contracts, and translation services, and the bill includes provisions for penalties, contract termination, and state reimbursement to local agencies for mandated costs.
>- **Keywords**: artificial-intelligence, public-contracts, california, call-centers, labor-law, state-legislation, worker-protection, automation
>- **Hash Tags**: #artificial-intelligence, #public-contracts, #california, #call-centers, #labor-law, #state-legislation, #worker-protection, #automation
