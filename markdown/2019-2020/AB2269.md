...
tags:
  ...
  - technology
  - compliance
keywords: artificial-intelligence, california, legislation, automated-decision-systems, bias, privacy, civil-rights, technology, compliance
hashTags: '#artificial-intelligence, #california, #legislation, #automated-decision-systems, #bias, #privacy, #civil-rights, #technology, #compliance'
billNumber: 2269
...
summary: "California Assembly Bill 2269, introduced by Assembly Member Chau, proposes the Automated Decision Systems Accountability Act of 2020, which would require businesses providing automated decision systems (ADS) in California to continually test for biases, conduct impact assessments for fairness and discrimination, and report annually to the Department of Business Oversight. The bill aims to prevent discrimination by ensuring ADS do not have disproportionate adverse impacts on protected classes and mandates reassessment after significant modifications. It also requires the department to develop reporting procedures, enforce compliance with civil penalties, and establish an advisory task force to review and advise on ADS use in various settings."
...
> California Assembly Bill 2269, introduced by Assembly Member Chau, proposes the Automated Decision Systems Accountability Act of 2020, which would require businesses providing automated decision systems (ADS) in California to continually test for biases, conduct impact assessments for fairness and discrimination, and report annually to the Department of Business Oversight. The bill aims to prevent discrimination by ensuring ADS do not have disproportionate adverse impacts on protected classes and mandates reassessment after significant modifications. It also requires the department to develop reporting procedures, enforce compliance with civil penalties, and establish an advisory task force to review and advise on ADS use in various settings.
...
>- **Topic**: AB-2269: Personal rights: automated decision systems.
>- **Title**: AB-2269: An act to add Title 1.81.8 (commencing with Section 1798.400) to Part 4 of Division 3 of the Civil Code, relating to automatic decision systems.
>- **TL;DR Summary**: California Assembly Bill 2269, introduced by Assembly Member Chau, proposes the Automated Decision Systems Accountability Act of 2020, which would require businesses providing automated decision systems (ADS) in California to continually test for biases, conduct impact assessments for fairness and discrimination, and report annually to the Department of Business Oversight. The bill aims to prevent discrimination by ensuring ADS do not have disproportionate adverse impacts on protected classes and mandates reassessment after significant modifications. It also requires the department to develop reporting procedures, enforce compliance with civil penalties, and establish an advisory task force to review and advise on ADS use in various settings.
>- **Keywords**: artificial-intelligence, california, legislation, automated-decision-systems, bias, privacy, civil-rights, technology, compliance
>- **Hash Tags**: #artificial-intelligence, #california, #legislation, #automated-decision-systems, #bias, #privacy, #civil-rights, #technology, #compliance
