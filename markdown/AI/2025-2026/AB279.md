...
tags:
  ...
  - media-literacy
  - technology
keywords: artificial-intelligence, education, school-libraries, california, legislation, standards, media-literacy, technology
hashTags: '#artificial-intelligence, #education, #school-libraries, #california, #legislation, #standards, #media-literacy, #technology'
billNumber: 279
...
summary: "Assembly Bill No. 279, introduced by Assembly Member Patel in the 2025–2026 California legislative session, proposes that the Superintendent of Public Instruction, in consultation with the State Board of Education, periodically review and recommend revisions to school library standards every eight years starting July 1, 2028. If revisions are recommended, a group of experts—including teachers familiar with technology, media literacy, artificial intelligence, credentialed teacher librarians, administrators, professors, and industry representatives—will assist in developing updates. The process requires at least two public hearings for community input, and the revised standards must be presented to the State Board, which will adopt, modify, or reject them within a set timeframe. The bill's implementation depends on specific budget appropriations."
...
> Assembly Bill No. 279, introduced by Assembly Member Patel in the 2025–2026 California legislative session, proposes that the Superintendent of Public Instruction, in consultation with the State Board of Education, periodically review and recommend revisions to school library standards every eight years starting July 1, 2028. If revisions are recommended, a group of experts—including teachers familiar with technology, media literacy, artificial intelligence, credentialed teacher librarians, administrators, professors, and industry representatives—will assist in developing updates. The process requires at least two public hearings for community input, and the revised standards must be presented to the State Board, which will adopt, modify, or reject them within a set timeframe. The bill's implementation depends on specific budget appropriations.
...
>- **Topic**: AB-279: School libraries: model library standards.
>- **Title**: AB-279: An act to add Section 60605.14 to the Education Code, relating to school libraries.
>- **TL;DR Summary**: Assembly Bill No. 279, introduced by Assembly Member Patel in the 2025–2026 California legislative session, proposes that the Superintendent of Public Instruction, in consultation with the State Board of Education, periodically review and recommend revisions to school library standards every eight years starting July 1, 2028. If revisions are recommended, a group of experts—including teachers familiar with technology, media literacy, artificial intelligence, credentialed teacher librarians, administrators, professors, and industry representatives—will assist in developing updates. The process requires at least two public hearings for community input, and the revised standards must be presented to the State Board, which will adopt, modify, or reject them within a set timeframe. The bill's implementation depends on specific budget appropriations.
>- **Keywords**: artificial-intelligence, education, school-libraries, california, legislation, standards, media-literacy, technology
>- **Hash Tags**: #artificial-intelligence, #education, #school-libraries, #california, #legislation, #standards, #media-literacy, #technology
