...
tags:
  ...
  - disclaimer
  - medical-board
keywords: artificial-intelligence, health-care, patient-communication, california-law, regulation, generative-ai, disclaimer, medical-board
hashTags: '#artificial-intelligence, #health-care, #patient-communication, #california-law, #regulation, #generative-ai, #disclaimer, #medical-board'
billNumber: 3030
...
summary: "Assembly Bill No. 3030 (Chapter 848), approved on September 28, 2024, requires California health facilities, clinics, and physician offices that use generative artificial intelligence (AI) to create written or verbal patient communications about clinical information to include a clear disclaimer indicating the use of AI and provide instructions for contacting a human health care provider. The requirements do not apply if a licensed or certified health care provider reviews the AI-generated communication. Violations are subject to enforcement by the appropriate licensing boards or authorities."
...
> Assembly Bill No. 3030 (Chapter 848), approved on September 28, 2024, requires California health facilities, clinics, and physician offices that use generative artificial intelligence (AI) to create written or verbal patient communications about clinical information to include a clear disclaimer indicating the use of AI and provide instructions for contacting a human health care provider. The requirements do not apply if a licensed or certified health care provider reviews the AI-generated communication. Violations are subject to enforcement by the appropriate licensing boards or authorities.
...
>- **Topic**: AB-3030: Health care services: artificial intelligence.
>- **Title**: AB-3030: An act to add Chapter 2.13 (commencing with Section 1339.75) to Division 2 of the Health and Safety Code, relating to health care services.
>- **TL;DR Summary**: Assembly Bill No. 3030 (Chapter 848), approved on September 28, 2024, requires California health facilities, clinics, and physician offices that use generative artificial intelligence (AI) to create written or verbal patient communications about clinical information to include a clear disclaimer indicating the use of AI and provide instructions for contacting a human health care provider. The requirements do not apply if a licensed or certified health care provider reviews the AI-generated communication. Violations are subject to enforcement by the appropriate licensing boards or authorities.
>- **Keywords**: artificial-intelligence, health-care, patient-communication, california-law, regulation, generative-ai, disclaimer, medical-board
>- **Hash Tags**: #artificial-intelligence, #health-care, #patient-communication, #california-law, #regulation, #generative-ai, #disclaimer, #medical-board
