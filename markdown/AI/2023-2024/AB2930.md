...
keywords: artificial-intelligence, california, legislation, algorithmic-discrimination, civil-rights, automated-decision-systems, employment-law, privacy, technology-regulation
hashTags: '#artificial-intelligence, #california, #legislation, #algorithmic-discrimination, #civil-rights, #automated-decision-systems, #employment-law, #privacy, #technology-regulation'
billNumber: 2930
...
summary: "Assembly Bill 2930, introduced by Assembly Member Bauer-Kahan in the 2023–2024 California legislative session, seeks to regulate the use of automated decision systems (including those powered by artificial intelligence) in consequential decisions affecting individuals' rights and opportunities, such as employment and access to services. The bill requires developers and deployers of such systems to conduct and document annual impact assessments to identify and mitigate risks of algorithmic discrimination, notify individuals when such systems are used, provide transparency and alternatives where feasible, and allow for correction of personal data. It prohibits the use or sale of these systems if there is a reasonable risk of discrimination until that risk is addressed. The Civil Rights Department is empowered to enforce compliance, including penalties for violations involving algorithmic discrimination, and trade secrets disclosed in assessments are protected from public records requests."
...
> Assembly Bill 2930, introduced by Assembly Member Bauer-Kahan in the 2023–2024 California legislative session, seeks to regulate the use of automated decision systems (including those powered by artificial intelligence) in consequential decisions affecting individuals' rights and opportunities, such as employment and access to services. The bill requires developers and deployers of such systems to conduct and document annual impact assessments to identify and mitigate risks of algorithmic discrimination, notify individuals when such systems are used, provide transparency and alternatives where feasible, and allow for correction of personal data. It prohibits the use or sale of these systems if there is a reasonable risk of discrimination until that risk is addressed. The Civil Rights Department is empowered to enforce compliance, including penalties for violations involving algorithmic discrimination, and trade secrets disclosed in assessments are protected from public records requests.
...
>- **Topic**: AB-2930: Automated decision systems.
>- **Title**: AB-2930: An act to add Chapter 25 (commencing with Section 22756) to Division 8 of the Business and Professions Code, relating to artificial intelligence.
>- **TL;DR Summary**: Assembly Bill 2930, introduced by Assembly Member Bauer-Kahan in the 2023–2024 California legislative session, seeks to regulate the use of automated decision systems (including those powered by artificial intelligence) in consequential decisions affecting individuals' rights and opportunities, such as employment and access to services. The bill requires developers and deployers of such systems to conduct and document annual impact assessments to identify and mitigate risks of algorithmic discrimination, notify individuals when such systems are used, provide transparency and alternatives where feasible, and allow for correction of personal data. It prohibits the use or sale of these systems if there is a reasonable risk of discrimination until that risk is addressed. The Civil Rights Department is empowered to enforce compliance, including penalties for violations involving algorithmic discrimination, and trade secrets disclosed in assessments are protected from public records requests.
>- **Keywords**: artificial-intelligence, california, legislation, algorithmic-discrimination, civil-rights, automated-decision-systems, employment-law, privacy, technology-regulation
>- **Hash Tags**: #artificial-intelligence, #california, #legislation, #algorithmic-discrimination, #civil-rights, #automated-decision-systems, #employment-law, #privacy, #technology-regulation
